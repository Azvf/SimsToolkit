...
public sealed class CrossPlatformConfigurationProvider : IConfigurationProvider
{
    ...
    private static Dictionary<string, object> InitializeDefaultValues()
    {
        return new Dictionary<string, object>
        {
            ...
            ["Performance.ModIndex.FastWorkers"] = 16,
            ["Performance.ModIndex.DeepWorkers"] = 10,
            ["Performance.TrayCache.ParseWorkers"] = 16,
            ["Performance.TrayCache.WriteBatchSize"] = 512,
            ["Performance.TrayCache.ParseResultChannelCapacity"] = 4096,
            ["Performance.TrayCache.CommitBatchSize"] = 2048,
            ["Performance.TrayCache.CommitIntervalMs"] = 1200,
            ["Performance.TrayCache.IncrementalOrphanCleanup"] = true,
            ["Performance.TrayMetadata.ParseWorkers"] = 12,
            ["Performance.IdlePrewarm.Enabled"] = true,
            ["Performance.IdlePrewarm.DelayMs"] = 10000,
            ["Performance.IdlePrewarm.MaxConcurrentJobs"] = 1,
            ["Performance.IdlePrewarm.TrayDependencyWorkerCount"] = 1,
            ["Performance.IdlePrewarm.ModQueryPrimeEnabled"] = true,
            ["Performance.IdlePrewarm.SaveDescriptorPrimeEnabled"] = true,
            ["Performance.IdlePrewarm.SaveArtifactPrimeEnabled"] = true,
            ["Performance.TrayBundleCache.MaxEntries"] = 64,
            ["Performance.TrayPreviewRootSnapshot.MaxPersistedRoots"] = 8,
            ["Performance.Organize.MaxParallelArchives"] = 8,
            ["Performance.SavePreview.Workers"] = 12,
            ["Performance.Round2.TrayCachePipelineEnabled"] = true,
            ["Performance.Round2.TrayCacheThrottleV2Enabled"] = true,
            ["Performance.Round2.OrganizeParallelEnabled"] = true,
