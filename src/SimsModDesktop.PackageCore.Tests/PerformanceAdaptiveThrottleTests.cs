...
public sealed class PerformanceAdaptiveThrottleTests
{
    ...
    [Fact]
    public void Update_UsesActualElapsedWindowForThroughputComputation()
    {
        var now = new DateTime(2026, 3, 5, 0, 0, 0, DateTimeKind.Utc);
        var throttle = new PerformanceAdaptiveThrottle(
            targetWorkers: 8,
        ...
        throttle.Update(50, now.AddSeconds(5), workingSetBytes: 100, baselineWorkingSetBytes: 100);
        throttle.Update(95, now.AddSeconds(20), workingSetBytes: 100, baselineWorkingSetBytes: 100);
        throttle.Update(140, now.AddSeconds(35), workingSetBytes: 100, baselineWorkingSetBytes: 100);
        var decision = throttle.Update(185, now.AddSeconds(50), workingSetBytes: 100, baselineWorkingSetBytes: 100);
